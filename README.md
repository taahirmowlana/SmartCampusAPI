...
4. Start the Server: Navigate to Source Packages -> com.smartcampus.config -> ApiLauncher.java, right-click, and select Run File.
5. Check the output console for the "Jarvis Systems Online" confirmation. The API will launch on http://localhost:8081/api/v1/.
