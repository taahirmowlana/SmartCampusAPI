...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/taahirmowlana/SmartCampusAPI.git](https://github.com/taahirmowlana/SmartCampusAPI.git)

Open the project in Apache NetBeans IDE (or any Java IDE supporting Maven).

Resolve Dependencies: Right-click the project and select Clean and Build to allow Maven to download the Jersey/Grizzly dependencies.

Start the Server: Navigate to Source Packages -> com.smartcampus.config -> ApiLauncher.java, right-click, and select Run File.

Check the output console for the "Jarvis Systems Online" confirmation. The API will launch on http://localhost:8081/api/v1/.
